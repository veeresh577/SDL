...
public static class Params{
	...
	public static void initParams(){
		...
		myParams = new Params[178];
		
		for(int i=0; i<myParams.length; i++){
			myParams[i] = new Params();
		}
		
		myParams[0].paramNum=138;
		myParams[0].paramVal=0;
		myParams[1].paramNum=402;
		myParams[1].paramVal=0;
		myParams[2].paramNum=136;
		myParams[2].paramVal=99;
		myParams[3].paramNum=137;
		myParams[3].paramVal=6;
		myParams[4].paramNum=45;
		myParams[4].paramVal=0;
		myParams[5].paramNum=94;
		myParams[5].paramVal=0;
		myParams[6].paramNum=298;
		myParams[6].paramVal=1;
		myParams[7].paramNum=306;
		myParams[7].paramVal=1;
		myParams[8].paramNum=361;
		myParams[8].paramVal=1;
		myParams[9].paramNum=323;
		myParams[9].paramVal=0;
		myParams[10].paramNum=300;
		myParams[10].paramVal=1;
		myParams[11].paramNum=301;
		myParams[11].paramVal=0;
		myParams[12].paramNum=315;
		myParams[12].paramVal=0;
		myParams[13].paramNum=316;
		myParams[13].paramVal=0;
		myParams[14].paramNum=317;
		myParams[14].paramVal=479;
		myParams[15].paramNum=318;
		myParams[15].paramVal=751;
		myParams[16].paramNum=302;
		myParams[16].paramVal=0;
		myParams[17].paramNum=304;
		myParams[17].paramVal=1;
		myParams[18].paramNum=305;
		myParams[18].paramVal=65;
		myParams[19].paramNum=564;
		myParams[19].paramVal=0;
		myParams[20].paramNum=303;
		myParams[20].paramVal=2;
		myParams[21].paramNum=93;
		myParams[21].paramVal=0;
		myParams[22].paramNum=313;
		myParams[22].paramVal=1;
		myParams[23].paramNum=314;
		myParams[23].paramVal=2;
		myParams[24].paramNum=366;
		myParams[24].paramVal=400;
		myParams[25].paramNum=367;
		myParams[25].paramVal=100;
		myParams[26].paramNum=421;
		myParams[26].paramVal=65;
		myParams[27].paramNum=324;
		myParams[27].paramVal=0;
		myParams[28].paramNum=1;
		myParams[28].paramVal=1;
		myParams[29].paramNum=2;
		myParams[29].paramVal=1;
		myParams[30].paramNum=12;
		myParams[30].paramVal=0;
		myParams[31].paramNum=4;
		myParams[31].paramVal=1;
		myParams[32].paramNum=3;
		myParams[32].paramVal=1;
		myParams[33].paramNum=83;
		myParams[33].paramVal=0;
		myParams[34].paramNum=16;
		myParams[34].paramVal=0;
		myParams[35].paramNum=579;
		myParams[35].paramVal=0;
		myParams[36].paramNum=580;
		myParams[36].paramVal=0;
		myParams[37].paramNum=80;
		myParams[37].paramVal=10;
		myParams[38].paramNum=672;
		myParams[38].paramVal=1;
		myParams[39].paramNum=40;
		myParams[39].paramVal=1;
		myParams[40].paramNum=41;
		myParams[40].paramVal=1;
		myParams[41].paramNum=42;
		myParams[41].paramVal=1;
		myParams[42].paramNum=34;
		myParams[42].paramVal=1;
		myParams[43].paramNum=35;
		myParams[43].paramVal=1;
		myParams[44].paramNum=36;
		myParams[44].paramVal=1;
		myParams[45].paramNum=37;
		myParams[45].paramVal=0;
		myParams[46].paramNum=38;
		myParams[46].paramVal=0;
		myParams[47].paramNum=39;
		myParams[47].paramVal=0;
		myParams[48].paramNum=576;
		myParams[48].paramVal=0;
		myParams[49].paramNum=85;
		myParams[49].paramVal=0;
		myParams[50].paramNum=730;
		myParams[50].paramVal=1;
		myParams[51].paramNum=617;
		myParams[51].paramVal=0;
		myParams[52].paramNum=8;
		myParams[52].paramVal=1;
		myParams[53].paramNum=209;
		myParams[53].paramVal=0;
		myParams[54].paramNum=210;
		myParams[54].paramVal=0;
		myParams[55].paramNum=14;
		myParams[55].paramVal=1;
		myParams[56].paramNum=84;
		myParams[56].paramVal=1;
		myParams[57].paramNum=0;
		myParams[57].paramVal=1;
		myParams[58].paramNum=13;
		myParams[58].paramVal=0;
		myParams[59].paramNum=86;
		myParams[59].paramVal=0;
		myParams[60].paramNum=231;
		myParams[60].paramVal=0;
		myParams[61].paramNum=18;
		myParams[61].paramVal=2;
		myParams[62].paramNum=19;
		myParams[62].paramVal=55;
		myParams[63].paramNum=48;
		myParams[63].paramVal=0;
		myParams[64].paramNum=43;
		myParams[64].paramVal=0;
		myParams[65].paramNum=17;
		myParams[65].paramVal=0;
		myParams[66].paramNum=9;
		myParams[66].paramVal=0;
		myParams[67].paramNum=26;
		myParams[67].paramVal=4;
		myParams[68].paramNum=27;
		myParams[68].paramVal=55;
		myParams[69].paramNum=10;
		myParams[69].paramVal=0;
		myParams[70].paramNum=28;
		myParams[70].paramVal=4;
		myParams[71].paramNum=29;
		myParams[71].paramVal=55;
		myParams[72].paramNum=52;
		myParams[72].paramVal=0;
		myParams[73].paramNum=47;
		myParams[73].paramVal=0;
		myParams[74].paramNum=6;
		myParams[74].paramVal=1;
		myParams[75].paramNum=22;
		myParams[75].paramVal=14;
		myParams[76].paramNum=23;
		myParams[76].paramVal=0;
		myParams[77].paramNum=49;
		myParams[77].paramVal=0;
		myParams[78].paramNum=44;
		myParams[78].paramVal=0;
		myParams[79].paramNum=82;
		myParams[79].paramVal=0;
		myParams[80].paramNum=5;
		myParams[80].paramVal=0;
		myParams[81].paramNum=20;
		myParams[81].paramVal=12;
		myParams[82].paramNum=21;
		myParams[82].paramVal=0;
		myParams[83].paramNum=7;
		myParams[83].paramVal=0;
		myParams[84].paramNum=24;
		myParams[84].paramVal=5;
		myParams[85].paramNum=25;
		myParams[85].paramVal=55;
		myParams[86].paramNum=54;
		myParams[86].paramVal=0;
		myParams[87].paramNum=55;
		myParams[87].paramVal=0;
		myParams[88].paramNum=11;
		myParams[88].paramVal=0;
		myParams[89].paramNum=30;
		myParams[89].paramVal=4;
		myParams[90].paramNum=31;
		myParams[90].paramVal=55;
		myParams[91].paramNum=50;
		myParams[91].paramVal=0;
		myParams[92].paramNum=46;
		myParams[92].paramVal=0;
		myParams[93].paramNum=51;
		myParams[93].paramVal=1;
		myParams[94].paramNum=408;
		myParams[94].paramVal=0;
		myParams[95].paramNum=581;
		myParams[95].paramVal=0;
		myParams[96].paramNum=618;
		myParams[96].paramVal=0;
		myParams[97].paramNum=619;
		myParams[97].paramVal=14;
		myParams[98].paramNum=620;
		myParams[98].paramVal=0;
		myParams[99].paramNum=621;
		myParams[99].paramVal=0;
		myParams[100].paramNum=622;
		myParams[100].paramVal=0;
		myParams[101].paramNum=623;
		myParams[101].paramVal=0;
		myParams[102].paramNum=586;
		myParams[102].paramVal=0;
		myParams[103].paramNum=89;
		myParams[103].paramVal=1;
		myParams[104].paramNum=90;
		myParams[104].paramVal=1;
		myParams[105].paramNum=95;
		myParams[105].paramVal=1;
		myParams[106].paramNum=91;
		myParams[106].paramVal=1;
		myParams[107].paramNum=96;
		myParams[107].paramVal=1;
		myParams[108].paramNum=290;
		myParams[108].paramVal=1;
		myParams[109].paramNum=291;
		myParams[109].paramVal=1;
		myParams[110].paramNum=718;
		myParams[110].paramVal=0;
		myParams[111].paramNum=326;
		myParams[111].paramVal=1;
		myParams[112].paramNum=592;
		myParams[112].paramVal=0;
		myParams[113].paramNum=611;
		myParams[113].paramVal=0;
		myParams[114].paramNum=338;
		myParams[114].paramVal=1;
		myParams[115].paramNum=339;
		myParams[115].paramVal=0;
		myParams[116].paramNum=728;
		myParams[116].paramVal=3;
		myParams[117].paramNum=340;
		myParams[117].paramVal=0;
		myParams[118].paramNum=397;
		myParams[118].paramVal=0;
		myParams[119].paramNum=341;
		myParams[119].paramVal=0;
		myParams[120].paramNum=342;
		myParams[120].paramVal=0;
		myParams[121].paramNum=371;
		myParams[121].paramVal=0;
		myParams[122].paramNum=344;
		myParams[122].paramVal=0;
		myParams[123].paramNum=427;
		myParams[123].paramVal=0;
		myParams[124].paramNum=15;
		myParams[124].paramVal=1;
		myParams[125].paramNum=227;
		myParams[125].paramVal=0;
		myParams[126].paramNum=123;
		myParams[126].paramVal=0;
		myParams[127].paramNum=292;
		myParams[127].paramVal=1;
		myParams[128].paramNum=588;
		myParams[128].paramVal=0;
		myParams[129].paramNum=537;
		myParams[129].paramVal=0;
		myParams[130].paramNum=294;
		myParams[130].paramVal=1;
		myParams[131].paramNum=293;
		myParams[131].paramVal=1;
		myParams[132].paramNum=587;
		myParams[132].paramVal=0;
		myParams[133].paramNum=573;
		myParams[133].paramVal=1;
		myParams[134].paramNum=574;
		myParams[134].paramVal=1;
		myParams[135].paramNum=589;
		myParams[135].paramVal=0;
		myParams[136].paramNum=78;
		myParams[136].paramVal=1;
		myParams[137].paramNum=77;
		myParams[137].paramVal=1;
		myParams[138].paramNum=381;
		myParams[138].paramVal=6;
		// 2013-08-07 JPW - Added 5 new parameters
		myParams[139].paramNum=900;
		myParams[139].paramVal=0;
		myParams[140].paramNum=902;
		myParams[140].paramVal=1;
		myParams[141].paramNum=901;
		myParams[141].paramVal=1;
		myParams[142].paramNum=716;
		myParams[142].paramVal=0;
		myParams[143].paramNum=905;
		myParams[143].paramVal=0;
		myParams[144].paramNum = 761;
		myParams[144].paramVal = 2;
		myParams[145].paramNum = 1167;
		myParams[145].paramVal = 0;
		myParams[146].paramNum = 1168;
		myParams[146].paramVal = 0;
		// 2014-12-5 - Added 14 new parameters
		myParams[147].paramNum = 514;
		myParams[147].paramVal = 1;
		myParams[148].paramNum = 764;
		myParams[148].paramVal = 10;
		myParams[149].paramNum = 590;
		myParams[149].paramVal = 1;
		myParams[150].paramNum = 762;
		myParams[150].paramVal = 1;
		myParams[151].paramNum = 1289;
		myParams[151].paramVal = 0;
		myParams[152].paramNum = 577;
		myParams[152].paramVal = 0;
		myParams[153].paramNum = 578;
		myParams[153].paramVal = 1;
		myParams[154].paramNum = 223;
		myParams[154].paramVal = 10;
		myParams[155].paramNum = 1208;
		myParams[155].paramVal = 0;
		myParams[156].paramNum = 1254;
		myParams[156].paramVal = 0;
		myParams[157].paramNum = 1209;
		myParams[157].paramVal = 0;
		myParams[158].paramNum = 1121;
		myParams[158].paramVal = 1;
		myParams[159].paramNum = 1210;
		myParams[159].paramVal = 0;
		myParams[160].paramNum = 1288;
		myParams[160].paramVal = 1;
		// 2015-21-9 - Added 15 new parameters
		myParams[161].paramNum = 546;
		myParams[161].paramVal = -1;
		myParams[162].paramNum = 680;
		myParams[162].paramVal = 0;
		myParams[163].paramNum = 685;
		myParams[163].paramVal = 0;
		myParams[164].paramNum = 681;
		myParams[164].paramVal = 0;
		myParams[165].paramNum = 682;
		myParams[165].paramVal = 0;
		myParams[166].paramNum = 683;
		myParams[166].paramVal = 0;
		myParams[167].paramNum = 687;
		myParams[167].paramVal = 0;
		myParams[168].paramNum = 691;
		myParams[168].paramVal = 1;
		myParams[169].paramNum = 689;
		myParams[169].paramVal = 3;
		myParams[170].paramNum = 690;
		myParams[170].paramVal = 100;
		myParams[171].paramNum = 686;
		myParams[171].paramVal = -1;
		myParams[172].paramNum = 695;
		myParams[172].paramVal = 50;
		myParams[173].paramNum = 688;
		myParams[173].paramVal = 1;
		myParams[174].paramNum = 694;
		myParams[174].paramVal = 0;
		myParams[175].paramNum = 856;
		myParams[175].paramVal = 0;
		// 2016-31-5 - Added 2 new parameters
		myParams[176].paramNum = 1438;
		myParams[176].paramVal = 0;
		myParams[177].paramNum = 429;
		myParams[177].paramVal = 0;
	...
	/**
	 * Sets the value of a specified bar code reader string parameter.136
	 *
	...
	/**
	 * Returns number of decoded bar codes from native getDecodeCount() method
	 * @return
	 */
	public int getNumberOfDecodes()
	{	
		return getDecodeCount();
	}
	/**
